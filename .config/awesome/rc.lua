...
globalkeys = my_table.join(
    ...
    awful.key({ modkey }, "F12", function () awful.util.spawn( "flameshot gui" ) end,
        {description = "screenshot area" , group = "function keys" }),
    ...
    -- awful.key({ modkey, "Shift"   }, "s", function(c) c.sticky.toggle end),
...
awful.rules.rules = {
   ...
   -- { rule = { class = "Subl" },
   --       properties = { tag = awful.screen.focused().selected_tag }
   --   },  
...
awful.spawn.with_shell("picom --experimental-backends -b --config  $HOME/.config/awesome/picom.conf")
